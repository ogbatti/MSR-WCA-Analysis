...
STRINGS = {
    ...
    "kpi_nationals_abroad": {
        "fr": "Réfugiés {nationality} en AOC",
        "en": "{nationality} refugees in WCA",
    },
    "kpi_nationals_abroad_fallback": {
    ...
    "asr_trends_title": {
        "fr": "Évolution de la population sur 10 ans",
        "en": "10-year population trends",
    },
    "asr_trends_help": {
